...
describe("Day 15 Part 2 module", function() {
  describe("#processData", function () {
    it("should return risk for lowest risk path given raw data", function() {
      ...
      assert.strictEqual(lowestRisk, 315);
    });
  });

  describe("#duplicateGrid", function() {
    // it.only("should return grid duplicated by 5", function() {
    //   const grid = module.duplicateGrid(new Grid(1, 1, [
    //     7,
    //   ]));

    //   assert.deepStrictEqual(grid.values, [
    //     7,8,9,0,1,
    //     8,9,0,1,2,
    //     9,0,1,2,3,
    //     0,1,2,3,4,
    ...
    // it.only("should return grid duplicated by 5", function() {
    //   const grid = module.duplicateGrid(new Grid(2, 2, [
    //     7,1,
    //     3,0,
    //   ]));
    ...
    it("should return grid duplicated by 5", function() {
      const grid = module.duplicateGrid(new Grid(10, 10, [
        1,1,6,3,7,5,1,7,4,2,
        1,3,8,1,3,7,3,6,7,2,
        2,1,3,6,5,1,1,3,2,8,
        3,6,9,4,9,3,1,5,6,9,
